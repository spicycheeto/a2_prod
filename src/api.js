...
export function reqPurchase(obj){
  console.log('confirmpurchase::')
  console.log(obj)
  return(
    fetch('/cart/confirmpurchase', {
      method: 'POST',
      headers:{
        'Accept': 'application/json,text/html,application/xhtml+xml,application/xml;q=0.9,q=0.8',
        'Content-Type': 'application/json'
...
export function reqRemoveProduct(obj){
  ...
  export function reqCreateProduct(obj){
    ...
    export function reqAddNewCategory(obj){

      return(
        fetch('cardDisplay/addNewCategory', {
          method: 'POST',
          headers:{
            'Accept': 'application/json,text/html,application/xhtml+xml,application/xml;q=0.9,q=0.8',
            'Content-Type': 'application/json'
...
export function reqRemoveCategory(obj){

  return(
    fetch('/cardDisplay/removeCategory', {
      method: 'POST',
      headers:{
        'Accept': 'application/json,text/html,application/xhtml+xml,application/xml;q=0.9,q=0.8',
        'Content-Type': 'application/json'
...
/****************************/
/****************************/
export function reqUpdateCounter(obj){

  return(
    fetch('/cardDisplay/updateCardState', {
      method: 'POST',
      headers:{
        'Accept': 'application/json,text/html,application/xhtml+xml,application/xml;q=0.9,q=0.8',
        'Content-Type': 'application/json'
